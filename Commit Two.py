# Коммит №2 - Слова: Загрузка слов из файла и правила игры.
import tkinter as tk
from tkinter import messagebox
import random
import os
#Не много добавил эмодзи для более эстетичного и красивого интерфейса.
#Добавлена загрузка списка слов, а также небольшой резерв слов для возможности теста игры.
...
class AliasGame:
    ...
    def show_rules(self):
        ...
        tk.Button(main_frame, text="Назад в меню",
                  font=("Arial", 18), command=self.show_menu).pack(pady=20)
    ...
    def game_settings_menu(self):
        ...
        main_frame = tk.Frame(self.root)
        main_frame.pack(expand=True)
#Чуть-чуть поправил архитектуру в коде, разделили пару строк для удобства чтения кода и его дальнейшего исправления.
